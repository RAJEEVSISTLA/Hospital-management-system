...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center"> BENEVOLENCE HOSPITALS</h2></br>
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> BENEVOLENCE HOSPITALS</a>
...
.list-group-item.active {
      background-color: #00ff00; /* Green color for active items */
      border-color: #00ff00;
      color: #ffffff;
    }

    .list-group-item {
      background-color: #ffffff; /* White color for non-active items */
      border-color: #ffffff;
      color: #000000;
    }
